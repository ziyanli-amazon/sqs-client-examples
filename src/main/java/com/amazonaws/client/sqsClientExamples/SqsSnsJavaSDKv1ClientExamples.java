...
public class SqsSnsJavaSDKv1ClientExamples {
    ...
    final static String TOPIC_NAME = UUID.randomUUID() + "-sns-sqs-topic";
    final static String QUEUE_NAME = UUID.randomUUID() + "-sns-sqs-queue";
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        GetQueueAttributesRequest getQueueAttributesRequest = new GetQueueAttributesRequest(queueUrl).withAttributeNames("QueueArn");
        ...
        System.out.println("Queue Policy has been set up correctly in order to send message from SNS topic.");
        ...
        SubscribeRequest subscribeRequest = new SubscribeRequest(topicArn, SNS_SUBSCRIPTION_PROTOCOL, queueArn);
        ...
        ReceiveMessageRequest receiveMessageRequest = new ReceiveMessageRequest().withQueueUrl(queueUrl).withWaitTimeSeconds(5);
        ...
        if (!receiveMessageResult.getMessages().isEmpty()) {
            ...
            System.out.println("The Message Body Size is: " + stringBytesCalculator(Utils.encodeUrl(receivedMessageBody)));
